...
const USER_CONFIG = {
   ...
   USERS: [
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "meCiz8XHS4jPDa5v4lBBGiIXKpBmjB1zvKSyClGJ62A",
      // 所在省份
      province: "广东",
      // 所在城市
      city: "广州",
  ...
  CALLBACK_TEMPLATE_ID: '9yphbijeOn3bC6AtHz3jGSTKucBA6n4YRbzg53VJW9g',
   ...
   */
   FESTIVALS: [
    // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
    {"type": "*生日", "name": "大哥", "year": "2003", "date": "10-16", isShowAge: true},
    // {"type": "节日", "name": "结婚纪念日", "year": "2020", "date": "09-03"},
    // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
